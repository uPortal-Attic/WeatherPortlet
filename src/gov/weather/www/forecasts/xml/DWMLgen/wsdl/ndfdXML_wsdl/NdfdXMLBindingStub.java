...
public class NdfdXMLBindingStub extends org.apache.axis.client.Stub implements gov.weather.www.forecasts.xml.DWMLgen.wsdl.ndfdXML_wsdl.NdfdXMLPortType {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "product"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.weather.gov/forecasts/xml/DWMLgen/schema/DWML.xsd", "productType"), gov.weather.www.forecasts.xml.DWMLgen.schema.DWML_xsd.ProductType.class, false, false);
        oper.addParameter(param);
        ...
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "weatherParameters"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.weather.gov/forecasts/xml/DWMLgen/schema/DWML.xsd", "weatherParametersType"), gov.weather.www.forecasts.xml.DWMLgen.schema.DWML_xsd.WeatherParametersType.class, false, false);
        oper.addParameter(param);
        ...
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "format"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.weather.gov/forecasts/xml/DWMLgen/schema/DWML.xsd", "formatType"), gov.weather.www.forecasts.xml.DWMLgen.schema.DWML_xsd.FormatType.class, false, false);
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        oper.setReturnClass(java.lang.String.class);
    ...
    public NdfdXMLBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            qName = new javax.xml.namespace.QName("http://www.weather.gov/forecasts/xml/DWMLgen/schema/DWML.xsd", "formatType");
            cachedSerQNames.add(qName);
            cls = gov.weather.www.forecasts.xml.DWMLgen.schema.DWML_xsd.FormatType.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(enumsf);
            cachedDeserFactories.add(enumdf);

            qName = new javax.xml.namespace.QName("http://www.weather.gov/forecasts/xml/DWMLgen/schema/DWML.xsd", "productType");
            cachedSerQNames.add(qName);
            cls = gov.weather.www.forecasts.xml.DWMLgen.schema.DWML_xsd.ProductType.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(enumsf);
            cachedDeserFactories.add(enumdf);

            qName = new javax.xml.namespace.QName("http://www.weather.gov/forecasts/xml/DWMLgen/schema/DWML.xsd", "weatherParametersType");
            cachedSerQNames.add(qName);
            cls = gov.weather.www.forecasts.xml.DWMLgen.schema.DWML_xsd.WeatherParametersType.class;
            cachedSerClasses.add(cls);
    ...
    public java.lang.String NDFDgen(java.math.BigDecimal latitude, java.math.BigDecimal longitude, gov.weather.www.forecasts.xml.DWMLgen.schema.DWML_xsd.ProductType product, java.util.Calendar startTime, java.util.Calendar endTime, gov.weather.www.forecasts.xml.DWMLgen.schema.DWML_xsd.WeatherParametersType weatherParameters) throws java.rmi.RemoteException {
        ...
        _call.setSOAPActionURI("http://www.weather.gov/forecasts/xml/DWMLgen/wsdl/ndfdXML.wsdl#NDFDgen");
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://www.weather.gov/forecasts/xml/DWMLgen/wsdl/ndfdXML.wsdl", "NDFDgen"));

        setRequestHeaders(_call);
        setAttachments(_call);
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {latitude, longitude, product, startTime, endTime, weatherParameters});
  ...
  throw axisFaultException;
    ...
    public java.lang.String NDFDgenByDay(java.math.BigDecimal latitude, java.math.BigDecimal longitude, java.util.Date startDate, java.math.BigInteger numDays, gov.weather.www.forecasts.xml.DWMLgen.schema.DWML_xsd.FormatType format) throws java.rmi.RemoteException {
        ...
        _call.setUseSOAPAction(true);
        _call.setSOAPActionURI("http://www.weather.gov/forecasts/xml/DWMLgen/wsdl/ndfdXML.wsdl#NDFDgenByDay");
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://www.weather.gov/forecasts/xml/DWMLgen/wsdl/ndfdXML.wsdl", "NDFDgenByDay"));

        setRequestHeaders(_call);
        setAttachments(_call);
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {latitude, longitude, startDate, numDays, format});
